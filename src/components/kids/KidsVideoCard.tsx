    ...
    <Link href={`/watch/${id}`} className="block">
      <div className="bg-white sm:rounded-3xl overflow-hidden shadow-sm hover:shadow-md hover:scale-[1.01] transition-all duration-300">
        ...
        <div className="p-4 flex gap-3 items-start">
          ...
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary to-blue-400 flex-shrink-0 border-2 border-white shadow-sm flex items-center justify-center text-white font-bold text-xs">
            KT
          </div>
          
          <div className="flex-1 min-w-0 pt-0.5">
            <h3 className="font-bold text-base leading-tight text-foreground line-clamp-2 mb-1">
              {title}
            </h3>
